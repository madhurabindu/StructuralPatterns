...
namespace App.Main.Decorator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            SecurityDecoratorSalesReport report = new SecurityDecoratorSalesReport(userName, pswd);
        ...
        private static void PrintUserAuthpirzation(SecurityDecoratorSalesReport report)
        {
            // Check if user is authorized
        ...
        /// </summary>
        /// <param name="report"></param>
        private static void PrintSalesReport(SecurityDecoratorSalesReport report)
        {
